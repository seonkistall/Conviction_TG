...
export function FeedClient({ markets }: Props) {
  ...
  return (
    ...
    <div className="relative mx-auto h-[100dvh] w-full md:max-w-[420px]">
      {/*
       * v2.26.2 — Live activity ticker. Pinned to the top of the
       * immersive column, below the back-chip / counter row. Hidden
       * on the end-of-feed terminator so the "🏁 You're all caught
       * up" moment isn't competing with a "Just now: @oracle.seoul"
       * ticker referring to markets the user has already exhausted.
       */}
